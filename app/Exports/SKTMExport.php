    ...
    WithColumnFormatting
{
    ...
    {
        // PERBAIKAN: Tambahkan 'submitter' dan 'validatorPerangkat' agar datanya ikut dimuat (Eager Loading)
        return SuketTidakMampu::with([
            'masyarakat',
            'rt',
            'perangkat',
            'kepala_desa',
    ...
    public function headings(): array
{
    return [
        ...
        'Validasi RT', 'Validasi Perangkat Desa', 'Validasi Kepala Desa', 'Ditolak Oleh',
        'Diajukan Oleh', 'Nama yang mengajukan', 'Tipe surat pengantar RT', 'Nama RT', 'Perangkat yang memvalidasi',
        'Dibuat', 'Diupdate'
    ];
}
