   ...
   <div class="kop-divider"></div>
    ...
    <div class="content">
        ...
        <p style="margin-top: 10px; margin-bottom: 5px;">
            <span>II.</span> {{ $data->poin_ii ?? 'Orang tersebut di atas benar-benar penduduk Desa Krajan Kecamatan Krajan Kabupaten Madiun dan orang tersebut diatas benar-benar belum menikah' }}
        </p>
