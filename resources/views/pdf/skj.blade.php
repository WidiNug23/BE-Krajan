...
<head>
    ...
    <style>
        ...
        /* Container untuk mengatur overlap Stempel & TTD */
        .ttd-container {
            position: relative;
        ...
        .stempel-kades {
            position: absolute;
            top: -30px;     /* Posisi stempel menimpa teks 'Kepala Desa' */
            left: -40px;    /* Posisi stempel menimpa TTD */
            width: 160px;   /* Ukuran HD agar tidak menciut */
            height: auto;
            z-index: 1;     /* Stempel di bawah TTD */
            opacity: 0.85;  /* Efek stempel basah transparan */
        }
...
<body>
    ...
    <div class="content">
        ...
        <p style="margin-top: 10px; margin-bottom: 5px;">
            <span>II.</span> {{ $data->poin_ii ?? 'Orang tersebut di atas benar-benar penduduk Desa Krajan Kecamatan Krajan Kabupaten Madiun dan orang tersebut benar-benar berstatus janda dari suami yang bernama ...................' }}
        </p>

        <p style="margin-bottom: 5px;">
            <span>III.</span> Surat keterangan ini dipergunakan untuk : Persyaratan <span class="bold">{{ $data->alasan }}</span>
        </p>
