...
<body>
    ...
    <div class="content">
        ...
        <p style="margin-top: 10px; margin-bottom: 5px;">
            <span>II.</span> {{ $data->poin_ii ?? 'Orang tersebut di atas benar-benar penduduk Kelurahan Krajan Kecamatan Mejayan Kabupaten Madiun dan orang tersebut diatas benar-benar memiliki usaha dibidang ' }}
        </p>
