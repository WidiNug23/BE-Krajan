...
<body>
        ...
        <tr>
            ...
            <td class="title-cell center">
                ...
                <div class="kop-subtitle">
                    RUKUN TETANGGA {{ str_pad($skj->rt->no_rt ?? '', 2, '0', STR_PAD_LEFT) ?: '....' }}
                </div>
    ...
    <div class="center">
        ...
        <p class="nomor-surat">Nomor: {{ $skj->no_surat_pengantar ?? '......../......../........' }}</p>
    </div>

    <p class="indent">
        Yang bertanda tangan di bawah ini, kami Ketua RT {{ str_pad($skj->rt->no_rt ?? '', 2, '0', STR_PAD_LEFT) ?: '....' }} 
    ...
    <table class="data-table">
        ...
        <tr>
            ...
            <td>:</td>
            <td>{{ $skj->kewarganegaraan }}</td>
        </tr>
        <tr>
            <td>Pendidikan</td>
            <td>:</td>
            <td>{{ $skj->pendidikan }}</td>
        </tr>
        <tr>
            <td>Status Perkawinan</td>
            <td>:</td>
            <td>{{ $skj->status_perkawinan }}</td>
        </tr>
        <tr>
            <td>Pekerjaan</td>
            <td>:</td>
        ...
        <tr>
            ...
            <td class="ttd-container">
                ...
                <div style="margin-top: 5px;">
                    <div class="bold">Ketua RT {{ str_pad($skj->rt->no_rt ?? '', 2, '0', STR_PAD_LEFT) }}</div>
                    ...
                    <div class="ttd-image">
                        @php
                            ...
                            if (!empty($skj->ttd_rt)) {
                                ...
                                if (Str::startsWith($skj->ttd_rt, ['http://', 'https://'])) {
                                    $ttdRtPath = public_path(parse_url($skj->ttd_rt, PHP_URL_PATH));
                                } else {
                                    // kalau sudah relative path
                                    $ttdRtPath = public_path($skj->ttd_rt);
                                }
                            }
                        @endphp
