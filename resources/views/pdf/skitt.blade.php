...
<head>
    <meta charset="utf-8">
    <title>Surat Keterangan Imunisasi TT (Tetanus Toxoid)</title>
    <style>
        ...
        body { 
            ...
            font-size: 10pt; /* Font diperkecil agar lebih profesional */
            line-height: 1.3;
            color: #000;
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="center">
        ...
        <p class="nomor-surat">Nomor : 470 / {{ $data->nomor_surat ?? '____' }} / 402.410.11 / {{ date('Y') }}</p>
    </div>
    ...
    <div class="content">
        ...
        <table class="table-data" style="margin-left: 20px;">
            <tr>
                <td width="28%">Nama</td>
                <td width="3%">:</td>
                <td>GUNAWAN WIBISONO, S.T</td>
            </tr>
            <tr>
                <td>Jabatan</td>
                <td>:</td>
                <td>Kepala Desa Krajan</td>
            </tr>
        </table>

        <p style="margin-top: 10px; margin-bottom: 2px;">Dengan ini menerangkan bahwa :</p>
        <table class="table-data" style="margin-left: 20px;">
            <tr><td width="28%">Nama Lengkap</td><td width="3%">:</td><td class="bold uppercase">{{ $data->nama }}</td></tr>
        ...
        <p style="margin-top: 10px; margin-bottom: 5px;">
            <span>II.</span> {{ $data->poin_ii ?? 'Orang tersebut di atas benar-benar penduduk Desa Krajan Kecamatan Krajan Kabupaten Madiun.' }}
        </p>

        <p style="margin-bottom: 5px;">
            <span>III.</span> Surat keterangan ini dipergunakan untuk: Mengajukan permohonan Suntik Imunisasi TT ke <span class="bold">{{ $data->fasilitas_kesehatan }}</span>
        </p>
