...
<head>
    ...
    <style>
        ...
        /* Container untuk mengatur posisi Stempel & TTD */
        .ttd-container {
            position: relative;
            display: inline-block;
            margin: 5px auto;
            width: 200px; /* Acuan posisi stempel */
        }
...
<body>
    ...
    <table class="kop-table">
        <tr>
            ...
            <td class="title-cell">
                ...
                <div class="kop-address">Jl. Bali No. 01 Kelurahan Krajan Kecamatan Mejayan Kota Caruban (63153)</div>
                <div class="kop-address">Pos-el : kelurahankrajan@gmail.com Laman : www.krajankel.madiunkab.go.id</div>
    ...
    <div class="content">
        ...
        <p style="margin-top: 10px; margin-bottom: 5px;">
            <span>II.</span> {{ $data->poin_ii ?? 'Orang tersebut di atas benar-benar penduduk Kelurahan Krajan Kecamatan Mejayan Kabupaten Madiun dan keadaan sosial ekonomi orang tersebut di atas benar-benar TIDAK MAMPU' }}
        </p>
